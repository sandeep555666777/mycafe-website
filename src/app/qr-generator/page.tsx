...
import { Download, Printer, Copy, QrCode, Table, Users, Clock } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-amber-100 p-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-amber-900 mb-2">QR Code Generator</h1>
          <p className="text-amber-700 text-lg">Generate and manage QR codes for your cafe tables</p>
        </div>
